...
If your assignment is ready to be uploaded to Code FREAK you have to create a `zip` or `tar` archive. The archive name itseld does not have to follow any naming scheme.
